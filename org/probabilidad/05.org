#+title:Condicionales
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="/home/mk/test.css"/>
#+HTML_MATHJAX: align: left indent: 0em tagside: right
* Condicionales
** Caso discreto
...
(35) se deduce que $| \rho (X, Y )| \leq 1$ y que $\rho(X, Y ) = ±1$
