...
F_X(x) = 0 y \displaystyle\lim_{x \rightarrow\infty}
F_X(x) = 1.
**** Demostración.
...
numerables átomos.
La propiedad de \sigma}-aditividad de la medida de probabilidad \mathbb{P} implica que el peso total
...
\alpha
X
es no vacío porque \displaystyle\lim_{x \rightarrow\infty}
F_X(x) = 1.
2. R}
\alpha
X
es acotado inferiormente porque \displaystyle\lim_{x \rightarrow−\infty}
F_X(x) = 0.
3. Si x
0
\in \Re
