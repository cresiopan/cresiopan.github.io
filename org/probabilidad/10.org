...
de $\theta$ podemos tratar de construir un in tervalo aleatorio $[\theta^− ,
...
Notar que el pivote para la varianza $Q(\mathbf{X}, \sigma^2)$ definido en (6) goza de
las propiedades enunciadas en la sección 1.1.1 para pivotes decrecientes:
- la función de distribución de $Q(\mathbf{X}, \sigma^2)$ es continua y estrictamente
  creciente
- para cada $\textbf{x}$, la función $Q(\mathbf{x}, \sigma^2)$ es continua y monótona
  decreciente respecto de $\sigma^2$.
En consecuencia, las cotas e intervalos de confianza para la varianza se pueden
construir usando el resolviendo la ecuación $Q(\mathbf{X}, \sigma^2) = \chi_{n-1,
...
Como el pivote para la varianza $Q(\mathbf{X}, \sigma^2 )$ goza de las propiedades
enunciadas en la sección 1.1.1 para pivotes decrecientes,
- la función de distribución de $Q(\mathbf{X}, \sigma^2)$ es continua y estrictamente
  creciente,
- para cada $x$, la función $Q(\mathbf{x}, \sigma^2)$ es continua y monótona decreciente
  respecto de $\sigma^2$,
...
\qquad$} & {cuando $m$ y $n \rightarrow \infty$}\end{array}$$
