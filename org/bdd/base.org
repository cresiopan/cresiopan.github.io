...
un obj solo puede ser accedido por el usu o grup al que pertenece.
existe el concepto de owner que puede permitir el acceso al recurso a otro usu o
grup (unix)

*** MAC (mandatory access control)

control de acceso es determinado por el sistema. se establecen relaciones entre
usus y objs (se asignan niveles). (dod)
...
*rollup*: realiza el agrupamiento por cada conjunto de atributos y de algunos de
sus subconjuntos
